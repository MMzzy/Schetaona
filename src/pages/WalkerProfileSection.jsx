...
export default function WalkerProfileSection({ isOnline, onToggleOnline }) {
          ...
          <div className="walker-info-col">
            <div className="walker-name-row">
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, background: 'var(--warm)', borderRadius: 12, padding: '8px 14px' }}>
