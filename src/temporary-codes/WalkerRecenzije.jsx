...
const STAR_COUNTS = [0, 0, 0, 1, 3]; // index = stars-1
        ...
        <div style={{ display: 'flex', gap: 40, alignItems: 'center', flexWrap: 'wrap' }}>
          ...
          <div style={{ textAlign: 'center', minWidth: 100 }}>
            <div style={{
              ...
              fontSize: 56, fontWeight: 900, color: 'var(--brown)', lineHeight: 1,
            }}>
              {avgRating}
            </div>
              ...
              <div style={{ flex: 1 }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 8 }}>
                  <div>
                    ...
                    <div style={{ fontSize: 12, color: 'var(--muted)', fontFamily: 'DM Sans, monospace' }}>
                      Pas: {r.dog}
                    </div>
                  </div>
